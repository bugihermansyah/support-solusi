...
class AdminSLAFinish extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $slug = 'reporting/monthly/admin/sla-finish';

    protected static ?string $navigationLabel = 'SLA Finish';

    protected static ?string $title = 'Admin SLA Finish';

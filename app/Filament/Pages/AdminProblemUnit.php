...
class AdminProblemUnit extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $slug = 'reporting/monthly/admin/problem-unit';
    ...
    protected static ?string $title = 'Admin Problem Unit';

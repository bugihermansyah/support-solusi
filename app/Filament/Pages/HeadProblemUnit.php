...
class HeadProblemUnit extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $slug = 'reporting/monthly/head/problem-unit';
    ...
    protected static ?string $title = 'Head Problem Unit';

...
class AdminProblemProduct extends Page implements HasTable
{
    use InteractsWithTable;
    use HasPageShield;

    protected static ?string $slug = 'reporting/monthly/admin/problem-product';
    ...
    protected static ?string $title = 'Admin Problem Product';
